    ...
    struct socket_ops {
        ...
        struct socket_close {
            void operator()(void* socket) {
                ...
                AZMQ_ASSERT_MSG(rc == 0, "set linger=0 on shutdown"); (void)rc;
                zmq_close(socket);
            }
        };
        ...
        static socket_type create_socket(context_ops::context_type context,
                                         int type,
                                         asio::error_code & ec) {
            AZMQ_ASSERT_MSG(context, "Invalid context");
        ...
        static stream_descriptor get_stream_descriptor(asio::io_service & io_service,
                                                       socket_type & socket,
                                                       asio::error_code & ec) {
            AZMQ_ASSERT_MSG(socket, "invalid socket");
        ...
        static asio::error_code cancel_stream_descriptor(stream_descriptor & sd,
                                                                  asio::error_code & ec) {
            AZMQ_ASSERT_MSG(sd, "invalid stream_descriptor");
            return sd->cancel(ec);
        }
        ...
        static auto send(ConstBufferSequence const& buffers,
            ...
            // typename std::enable_if<boost::has_range_const_iterator<ConstBufferSequence>, size_t>::type
        {
            size_t res = 0;
        ...
        static auto receive(MutableBufferSequence const& buffers,
                            ...
                            flags_type flags,
                            asio::error_code & ec) -> size_t
            // typename std::enable_if<boost::has_range_const_iterator<MutableBufferSequence>, size_t>::type
        {
            size_t res = 0;
            message msg;
